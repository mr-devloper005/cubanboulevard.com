...
export const editableRootStyle = {
  ...
  '--slot4-accent': '#63b63b',
  '--slot4-accent-fill': '#63b63b',
  '--slot4-accent-soft': '#e8f7df',
  '--slot4-on-accent': '#10200c',
  '--slot4-dark-bg': '#202121',
  ...
  '--editable-page-bg': '#eef1f8',
  '--editable-page-text': '#1a1a1a',
  '--editable-container': '1420px',
  '--editable-border': '#e6e6e6',
  '--editable-nav-bg': '#222323',
  '--editable-nav-text': '#ffffff',
  '--editable-nav-active': '#d32323',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#83ea69',
  '--editable-cta-text': '#152012',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#191a1a',
